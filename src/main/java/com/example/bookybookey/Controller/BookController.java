...
public class BookController {
    ...
    public ResponseEntity<String> addBookByISBN(@PathVariable String isbn) {
        try {
            Book book = bookService.addBookByISBN(isbn);
            return new ResponseEntity<>("Book added successfully: " + book.getBookTitle(), HttpStatus.CREATED);
